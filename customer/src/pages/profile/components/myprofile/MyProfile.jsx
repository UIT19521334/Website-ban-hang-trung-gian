  ...
  return (
    <div className="profile">
      ...
      <div className="profile_body">
        ...
        <div className="row">
          ...
          <div className="col-4">
            ...
            <button
              onClick={handlePasswordPopupOpen}
              className="buttonChangePass"
            >
              Reset password
            </button>
          </div>
      ...
      <Modal
        ...
        style={{ marginTop: 100 }}
        show={isvalidate}
        onHide={handleValidatePopupClose}
        animation={false}
      >
        <Modal.Header closeButton>
        ...
        <Modal.Body style={{ color: "red" }}>
          Woohoo, you're missing some fields
        </Modal.Body>
        <Modal.Footer>
      ...
      <Modal
        ...
        style={{ marginTop: 100 }}
        show={isSimilar}
        onHide={handleSimilarPopupClose}
        animation={false}
      >
        <Modal.Header closeButton>
        ...
        <Modal.Body style={{ color: "red" }}>
          Your new password and renew password don't similar
        </Modal.Body>
        <Modal.Footer>
